...
// A week-at-a-glance clock: seven day sectors, one hand per week and a
// color-coded ribbon of day parts with a matching background glow.
// Controls: [T] time-lapse, [R] real time, [S] save PNG, [H] hide UI;
// the same actions exist as clickable buttons (touch-friendly).
...
// Seven day parts from midnight, each with its own accent color; on the
// ring, Evening (21-24) is followed by Night (0-6) of the next day.
const DAY_PARTS = [
...
// Reverse iteration so removal never skips elements; ambient particles
// are reused, sparks and click bursts die out.
...
// Clickable buttons (touch-friendly); when the UI is hidden, a faint
